...
<body>
	<center>
		...
		<form action="#" method="POST">
			<input type="text" placeholder="Name" name="name" /><br> <input
				type="number" placeholder="Age" name="age" /><br> <input
				type="text" placeholder="Phone number" name="phone" /><br> <input
				type="text" placeholder="Mail" name="mail" /><br>
		...
		if ((request.getMethod()).equals("POST")) {
			try {
				...
				.prepareStatement("UPDATE Customers SET Name=?,Age=?,Phone=?,Mail=? WHERE Customer_ID=?");
