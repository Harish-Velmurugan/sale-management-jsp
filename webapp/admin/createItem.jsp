...
Manufactured Date: <input type="date" placeholder="Manufactured Date" name="manufacturedDate"/><br>
Expiry Date: <input type="date" placeholder="Expiry Date" name="expiryDate"/><br>
<input type="number" placeholder="Buying Cost" name="buyingCost"/><br>
