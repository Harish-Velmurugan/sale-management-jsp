...
<form action="#" method="POST">
	<input type = "hidden" name = "confirmOrder" value="false" />

	<input type="number" name="item_ID" placeholder ="item_ID" />
...
<%
	if(((Integer)session.getAttribute("isAdmin"))==1){ %>
		<a href="./adminMenu.html">Cancel Order</a>
<% 		
	}
	else{
%> <a href="./customerMenu.html">Cancel Order</a>
<% 
	}
%>
</body>
